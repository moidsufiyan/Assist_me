          ...
          <div className="flex items-center space-x-4 sm:space-x-6 text-xs sm:text-sm">
            {user ? (
              <>
                <Link
                  to="/chat"
                  className={`px-4 py-1.5 border-2 border-black transition-all font-bold ${isCurrent('/chat') ? 'bg-[#00F0FF] shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] translate-x-[-2px] translate-y-[-2px]' : 'bg-white hover:bg-slate-100 hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[-2px] hover:translate-y-[-2px]'}`}
                >
                  TERMINAL
                </Link>
                <Link
